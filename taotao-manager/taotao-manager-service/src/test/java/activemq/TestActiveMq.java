...
public class TestActiveMq {
	...
	public void testQueueProducer() throws Exception {
		...
		ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://192.168.80.140:61616");
		...
		TextMessage textMessage = session.createTextMessage("hello activemq11sd11");
		//8.发送消息
	...
	public void testTopicProducer() throws Exception {
		...
		Topic topic = session.createTopic("hai-topic");
		//创建一个Producer对象
		MessageProducer producer = session.createProducer(topic);
		//创建一个TextMessage对象
		TextMessage textMessage = session.createTextMessage("hello activemq topic1");
		//发送消息
		producer.send(textMessage);
		//关闭资源
		producer.close();
