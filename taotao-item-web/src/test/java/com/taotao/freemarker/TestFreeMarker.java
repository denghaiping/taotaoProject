...
public class TestFreeMarker {
	...
	public void testFreemarker() throws Exception {
		...
		//3.设置模板所在的路径
		configuration.setDirectoryForTemplateLoading(new File("F:/BaiduNetdiskDownload/taotao商城综合项目dubbo版/day10/代码/taotao-item-web/src/main/webapp/WEB-INF/ftl"));
		//4.设置模板的字符集，一般utf-8
		...
		Writer out = new FileWriter(new File("D:/freemarker/html/hello.html"));
